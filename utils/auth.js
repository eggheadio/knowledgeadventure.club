...
export const USER_KEY = 'egg_sellable_user'
export const ACCESS_TOKEN_KEY = 'egg_sellable_access_token'
export const EXPIRES_AT_KEY = 'egg_sellable_expires_at'
export const VIEWING_AS_USER_KEY = 'egg_sellable_viewing_as_user'
